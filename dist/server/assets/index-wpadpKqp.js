...
function Home() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-school-gold text-school-navy py-3 px-4 overflow-hidden shadow-inner flex", children: [
      /* @__PURE__ */ jsx("div", { className: "font-bold pr-4 border-r border-school-navy whitespace-nowrap z-10 bg-school-gold", children: "News:" }),
      /* @__PURE__ */ jsx("div", { className: "flex-grow overflow-hidden relative", children: /* @__PURE__ */ jsx("div", { className: "announcement-track whitespace-nowrap inline-block px-4 font-medium", children: "Admissions open for Academic Year 2026-2027" }) })
    ] }),
